...
const About = () => {
  ...
  return (
    <section id="about" className="bg-sectionBg-about dark:bg-sectionBg-dark-about transition-colors duration-500 ease-in-out relative">
      <div className="about-container px-6 py-20 text-center lg:max-w-[85%] 2xl:max-w-[70%] mx-auto z-[2] relative">
